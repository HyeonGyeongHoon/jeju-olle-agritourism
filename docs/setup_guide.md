...
### 1) 가상환경 생성
프로젝트 루트 디렉토리([jeju-olle-docent](file:///c:/Users/osr06/Desktop/jeju-olle-docent)) 로 이동한 후 다음 명령어를 실행합니다.
```powershell
python -m venv .venv
```
...
### 4) 의존성 라이브러리 설치
[requirements.txt](file:///c:/Users/osr06/Desktop/jeju-olle-docent/requirements.txt) 에 명시된 2주 스프린트 용 패키지들을 최신 상태로 설치합니다.
```powershell
...
- **환경 변수 파일 생성**:
  [jeju-olle-docent](file:///c:/Users/osr06/Desktop/jeju-olle-docent) 루트 디렉토리에 `.env` 파일 을 신규 생성하고 아래 키를 채웁니다.
  ```env
  SUPABASE_URL=your_supabase_project_url_here
  SUPABASE_KEY=your_supabase_anon_or_service_key_here
  OPENAI_API_KEY=your_openai_api_key_here
  ```
  참고용 예시 템플릿은 [.env.example](file:///c:/Users/osr06/Desktop/jeju-olle-docent/.env.example) 파일 을 참고하시기 바랍니다.
